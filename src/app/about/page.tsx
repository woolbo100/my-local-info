...
export const metadata = {
  ...
  description: "성남시 생활 정보 사이트의 운영 목적과 데이터 출처, 콘텐츠 생성 방식을 소개합니다.",
};
      ...
      <div className="space-y-12">
        ...
        <section className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-slate-100 shadow-sm">
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            본 사이트는 성남시 주민들이 지역의 다양한 **행사, 축제, 지원금, 그리고 각종 혜택 정보**를 보다 쉽고 빠르게 접할 수 있도록 돕기 위해 운영되고 있습니다.
          </p>
        ...
        <section className="bg-white p-8 md:p-12 rounded-[2.5rem] border border-slate-100 shadow-sm">
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            저희가 제공하는 모든 정보는 대한민국 정부의 **공공데이터포털(data.go.kr)**에서 제공하는 공식 API를 기반으로 합니다.
          </p>
