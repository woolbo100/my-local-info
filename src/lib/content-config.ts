...
export const CATEGORY_CONFIG: Record<CategoryRoute, CategoryConfig> = {
  ...
  events: {
    ...
    label: "행사",
    title: "부산 행사",
    description: "전시, 공연, 마켓, 지역 이벤트 등 부산 행사 정보를 모았습니다.",
    homeDescription: "공연, 전시, 팝업 같은 부산 행사 소식을 빠르게 확인해보세요.",
    emoji: "🎉",
    cardType: "festival",
    contentDirs: ["events"],
  },
  benefits: {
    ...
    homeDescription: "놓치기 쉬운 부산 지원·혜택 정보를 파일 기반으로 정리했어요.",
    emoji: "💰",
    cardType: "benefit",
  ...
  dates: {
    ...
    label: "데이트 코스",
    title: "부산 데이트 코스",
    description: "바다, 야경, 카페, 산책까지 아우르는 부산 데이트 코스를 정리했습니다.",
  ...
  blog: {
    ...
    label: "블로그",
    title: "부산나우 블로그",
    description: "부산의 생활과 여행, 로컬 이슈를 담은 블로그형 콘텐츠를 모았습니다.",
    homeDescription: "부산에 대한 핫한 정보들을 블로그에서 만나보세요.",
    emoji: "📝",
    cardType: "blog",
    contentDirs: ["blog"],
  },
