...
export const CATEGORY_CONFIG: Record<CategoryRoute, CategoryConfig> = {
  festivals: {
    ...
    label: "축제/행사",
    title: "부산 축제/행사",
    description: "부산에서 열리는 축제와 행사를 한눈에 확인해보세요.",
    homeDescription: "부산의 주요 축제와 행사 소식을 최신순으로 모아봤어요.",
    emoji: "🎉",
    cardType: "festival",
  ...
  benefits: {
    ...
    label: "지원/혜택",
    title: "부산 지원/혜택",
    description: "지원금, 복지, 청년정책, 소상공인 혜택을 최신순으로 정리합니다.",
    homeDescription: "놓치기 쉬운 부산 지원사업과 혜택 정보를 쉽게 정리했어요.",
    emoji: "💸",
    cardType: "benefit",
  ...
  food: {
    ...
    label: "부산 맛집",
    title: "부산 맛집",
    description: "동네별 부산 맛집과 카페, 간식 코스를 카드형으로 소개합니다.",
    homeDescription: "지금 가기 좋은 부산 맛집과 카페를 골라 보여드릴게요.",
    emoji: "🍽️",
    cardType: "place",
    contentDirs: ["food"],
  },
  hotplaces: {
    ...
    label: "핫플레이스",
    title: "부산 핫플레이스",
    description: "사진 찍기 좋고 분위기 좋은 부산의 핫플레이스를 모아봤습니다.",
    homeDescription: "요즘 반응 좋은 부산 핫플레이스만 모아 소개합니다.",
    emoji: "📍",
    cardType: "place",
  ...
  dates: {
    ...
    label: "데이트 코스",
    title: "부산 데이트 코스",
    description: "바다, 야경, 카페, 산책까지 아우르는 부산 데이트 코스를 정리합니다.",
  ...
  blog: {
    ...
    label: "블로그",
    title: "부산나우 블로그",
    description: "부산의 생활과 여행, 로컬 이슈를 다루는 블로그형 콘텐츠를 모아봤습니다.",
    homeDescription: "부산에 대한 다양한 이야기를 블로그에서 만나보세요.",
    emoji: "📝",
    cardType: "blog",
    contentDirs: ["blog"],
  },
